...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ...
	  for (var i = 0; i < pagination.children.length; i++) {
	    var ChildrenElement = pagination.children[i];
	...
	function slideTitle() {
	  ...
	  words = [].concat(_toConsumableArray(words));
	  ...
	  setInterval(function () {
	    ...
	    words.map(function (el) {
	      el.style.transform = 'translateY(' + nowSlide + '%)';
	    });
	...
	function activeMenu(e) {
	  ...
	  var active = document.querySelector('.active') ? document.querySelector('.active') : document.querySelector('.place');
	  var dir = wheel(e);
	...
	function dotSlide(dir) {
	  ...
	  var dotActive = document.querySelector('.pagination__dot_active');
	...
	function dotClick(e) {
	  var el = e.target;
	  var dotActive = document.querySelector('.pagination__dot_active');
	  var parent = document.querySelector('.pagination');
	  ...
	  var _loop = function _loop(_i) {
	    if (activeFinding) {
	      main.children[_i].classList.remove('old');
	    } else {

	      if (_i === newActiveIndex) {
	        main.children[_i].classList.remove('old');
	        setTimeout(function () {
	          return main.children[_i].classList.add('active');
	        }, 700);
	        activeFinding = true;
	      } else {
	        main.children[_i].classList.add('old');
	      }
	    }
	  };

	  for (var _i = 0; _i < main.children.length; _i++) {
	    _loop(_i);
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _photoswipeUiDefault = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*! PhotoSwipe Default UI - 4.1.1 - 2016-10-02
	* http://photoswipe.com
	* Copyright (c) 2016 Dmitry Semenov; */
	/**
	*
